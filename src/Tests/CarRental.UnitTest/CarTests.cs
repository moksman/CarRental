...
namespace CarRental.UnitTest
{
    public class CoreTests
    {
        ...
        {
            Car Action() => Car.Create(new (CarId), new (CityId), Brand, Model, Description, "", Seats, Price, VehiculeType, TransmissionType);
        ...
        public void Create_ShouldReturnCarWithGivenIdAndName()
        {
            ...
            // Act
            var car = Car.Create(new(id), new(cityId), brand, model, description, "", noOfSeats, price, type, transmission);
