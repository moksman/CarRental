...
public static class DependencyInjection
{
    public static IServiceCollection ConfigurePersistance(this IServiceCollection services, IConfiguration configuration) //where TId : class
    {
        ...
        services
            .AddScoped<IBaseRepository<Car, Guid>, BaseRepository<Car, Guid>>()
            .AddScoped<IBaseRepository<City, Guid>, BaseRepository<City, Guid>>()
            .AddScoped<IBaseRepository<User, Guid>, BaseRepository<User, Guid>>()
    ...
    public static IServiceCollection AddData(this IServiceCollection services)
    {
        ...
        //    City.Create(Guid.Parse("a454641b-de2d-4b92-b3c0-2ed7e56afa9c"), "Prague"),
        //    City.Create(Guid.NewGuid(), "Brno"),
        //    City.Create(Guid.NewGuid(), "Liberec"),
        //    City.Create(Guid.NewGuid(), "Pardubice"));

        //dbcontext.SaveChanges();

        //dbcontext.Cars.AddRange(
        //    Car.Create(
        //        Guid.Parse("2a959a26-1a1e-4dcd-a182-bfa8965a26bd"),
